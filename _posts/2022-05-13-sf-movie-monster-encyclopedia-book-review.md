...
서살 그들이 수많은 사람들을 해치고 다녔을지라도 말이다.
...
책장을 넘겨가며 자연스럽게 읽어나갈 수 없고 흐름이 끊기는 지점이 의외로 많다는 점이 그렇다.

많은 괴수, 괴인을 적은 페이지로 소화하려 한 문제는
괴수의 모습을 제대로 보여주지 못하는 것으로도 이어진다.
일반적인 모습과, 해부도, 움직임을 보여주는 것 등으로 나눠서 하나씩 확실하게 보여주는 게 아니라
한두 그림으로 이런 것들을 퉁치려는 면이 있어서다.

작화 스타일도 호불호가 갈릴 만하다.
어둡고 기괴한 느낌의 그림은 아트적으로야 그 나름의 매력도 있다만,
다소 뭉개지고 시인성이 떨어진다는 점에서
일종의 도감이라 할 수 있는 책의 컨셉과 썩 잘 어울리지는 않는다.
