...
![실내](https://lh3.googleusercontent.com/qS5E6YXrHH2lhTe3jZnnFN3sgf170hNr0nSsXALU6BsN3LstZFuS5QxzzW1lbdA0TCtHYEgw19jYDw=s560)
...
루아흐엔 CCTV도 설치되어 있으므로 도난 걱정을 크게 하지 않아도 될 것 같다.
...
OA 서비스는 월마다 무료매수(흑백 150매, 컬러 1매[^1])가 주어지며,
무료매수를 다 사용한 후에는 유료(흑백 100원, 컬러 200원)로 이용하는 방식이다.
무료 제공 내용도 나쁘지 않고, 유료 비용 무난한 수준이다.

[^1]: 루아흐 홈페이지와 제공 내용(매달 200매 지원)이 다른데, 바꼈거나 바뀔 예정인 듯하다.

![OA](https://lh3.googleusercontent.com/WPLdX8T2g8uXKkIUneLuqAEvY5vWPe9fFFp3nJ4K3zkCtUP5fLJgQvodHNXMTsi4GZ49xA-mYer_ew=s560)
...
개인적으로 캡슐을 구매하거나 캡슐 커피 비용 1000원을 내야한다.
...
루아흐에서는 방뭉 차량을 위해 1시간 무료 주차만을 제공한다.
고려빌딩 건물 주차장은 30분에 1,500원, 1시간 3,000원, 1일 10,000원이며 1개월은 90,000원을 받고있으며, 고려빌딩 건물 방침에 따르므로 그때 그때 확인해야 한다.

![주차장](https://lh3.googleusercontent.com/VLPq7n_kwxHIRBFBilb1v1HgC_uoIhpX1acfezKEMh3wkAO7-gifmPJ163BbborgUqynsRcMFiA3rg=s560)
...
모든 금액은 VAT 포함가며, 카드결제시 추가금을 요구하는 이상한 짓도 하지 않는다.
...
무료 제공 내용은 흑백 150매, 컬러 1매이며[^1],
이후 유료이용시엔 컬러 200원, 흑백 100원이 든다.

프리카페는 기본으로 무료이나, 캡슐커피의 경우 개당 1000원이 든다.
캡슐 커피는 돌체구스토 제품이 구비되어있다.

비상주 서비스는 잦은 출장으로 상주가 필요없는 사람을 위한 것으로,
사업자 주소지, 우편/택배 수령, 루아흐 내 비즈니스 프로그램 참여 가능 등을 제공한다.

신규계약 상담은 매니저가 상주해있는 월~금 10~17시, 토요일 10~14시에 가능하다.
전화를 통해 미리 예약하고 방문하면 된다.
