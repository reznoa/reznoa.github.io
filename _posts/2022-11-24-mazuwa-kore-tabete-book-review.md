...
가키에다에 관한 이야기는 다른 친구들을 통해서 조금씩 조각이 모여 맞춰지는 식으로 만들어졌는데,
그를 통해 그의 실종에 관한 비밀이 풀리게 되면서
이 평범해 보였던 일상 힐링물이 뜻밖의 이야기로 전환되기도 한다.

이게 좀 의외다 싶으면서도 좋았던 건,
그것이 전혀 느닷없거나 황당하지는 않기 때문이다.
다른 사람들의 이야기를 통해 둘러가면서 거기까지 이르는 과정에서
충분히 그러한 점으로 이어질법한 떡밥들을 잘 깔았다 할만해서
오히려 합당하게 느껴진다.
