...
음식을 먹은 후 pH는 급격히 떨어져 약 3분 후 pH 5.5 이하로 떨어져 산성을 띄는데,
이때 칫솔질을 하면 치아 마모가 심하다.[^1]
앞서 소개한 333의 '3분 이내'도 이런 이유로 나온 것이다.

[^1]: pH는 수소 이온 농도를 나타내는 것으로, pH가 7보다 낮으면 산성, 7보다 높으면 염기성이라고 한다. 산(Acid)은 치아를 쉽게 부식시킨다.
...
잘 닦이게 해주는데 뭐가 문제냐?
이게 피부 자극성 물질이라 염증을 일으킨다는 게 문제다.
