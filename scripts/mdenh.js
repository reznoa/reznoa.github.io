var MarkdownEnhancer =
{
	...
	initOnLoad : function(baseClassName)
	{
		document.addEventListener("DOMContentLoaded", function() {
			var baseElm = document.getElementsByClassName(baseClassName)[0];
			MarkdownEnhancer.footnotePopup(baseElm.className);
			MarkdownEnhancer.imageBlock( baseElm );
		});
	},
